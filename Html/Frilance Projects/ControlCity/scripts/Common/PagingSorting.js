function PagingSorting(containerSelector, urlArg, filterFormSelector) {
    ...
    function ajaxRequestInternal(changedData) {
       ...
       //alert(Parametrize.param({ StartDate: parametesData.StartDate, EndDate: parametesData.EndDate, Edited: parametesData.Edited, SelectedStatuses: parametesData.SelectedStatuses, SelectedCategories: parametesData.SelectedCategories, SelectedTypes: parametesData.SelectedTypes, Search: parametesData.Search, PagingSortingInfo: parametesData.PagingSortingInfo }))
       //var p = Parametrize.param({ StartDate: parametesData.StartDate, EndDate: parametesData.EndDate, Edited: parametesData.Edited, SelectedStatuses: parametesData.SelectedStatuses, SelectedCategories: parametesData.SelectedCategories, SelectedTypes: parametesData.SelectedTypes, Search: parametesData.Search, PagingSortingInfo: parametesData.PagingSortingInfo });
      //  if (window.history.replaceState) {
            //prevents browser from storing history with each change:
        //    window.history.replaceState("", "filter",p);
        //}
        var p = Parametrize.param(_.omit(parametesData, ['Categories', 'Types', 'Statuses']));
       // alert(p)
        //  if (window.history.replaceState) {
        //prevents browser from storing history with each change:
        //    window.history.replaceState("", "filter",p);
