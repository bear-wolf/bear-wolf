var SiteDialog = new function () {
    ...
    this.showImage = function (src) {
        ...
        dialog.container.find(".modal-body").append("<img class='lg-img' src='" + src + "'/>")
    ...
    this.showmap = function (options, mapdiv) {
        options.buttons.push({ text: 'Закрити', buttonClass: 'btn-default', click: function () { dialog.close() } })
        var dialog = this.show(options);
        dialog.container.find(".modal-body").html(mapdiv);
        dialog.close = function () {
            dialog.container.modal('hide');
        }
        this.current = dialog;
    }
    this.showdescription = function (options, content,element) {
        options.buttons.push({ text: 'Закрити', buttonClass: 'btn btn-default', click: function () { dialog.close();element.removeClass('active') } })
        var dialog = this.show(options);
        dialog.container.find(".modal-body").html(content);
        dialog.close = function () {
            dialog.container.modal('hide');
        }
        this.current = dialog;
