    ...
    return this.each(function () {
        ...
        var jItem = {
            ...
            Rotate: function (content) {
                var t = this;
                var pos = "";
                if (t.Animate.Position.bool_left) { p = "left"; }
                if (t.Animate.Position.bool_top) { p = "top"; }
        ...
        var jEvent = {
            ...
            ClickItem: function (o) {
                ...
                var mnoj = isNaN(parseInt(an.css("left"))) ? "0" : Math.abs(parseInt(an.css("left")));
            ...
            SwitchItem: function (o, l) {
                ...
                var off = o.Animate.Position.Left;
                t.MDirection();
                if (o.Item.border) {
                    ...
                    if (parseInt(t.prev_active) < parseInt(rel)) { l = "Right" }
                    else l = "Left";
        ...
        var jVisual = {
            ...
            Pager: function (obj) {
                ...
                jEvent.$active = t.$tag.find("a:first");
        ...
        rotateSwitch = function (o) {
            play = setInterval(function () { //Set timer - this will repeat itself every 3 seconds                
                ...
                o.Rotate(off); //Trigger the paging and slider function
