...
(function (a) {
    a.fn.visualLightbox = function (ah) {
        ...
        if (ah.animate) {
            var aW = Math.max(ah.overlayDuration,
				0);
            ah.resizeSpeed = Math.max(Math.min(
				ah.resizeSpeed, 10), 1);
        ...
        ah.overlayOpacity = Math.max(Math.min(
			ah.overlayOpacity, 1), 0);
        var az = ah.autoPlay;
        var au = a(ah.containerID);
        var m = ah.classNames;
        aO();
        var aK = au.length && au.get(0) !=
			document ? au.get(0) : document.getElementsByTagName(
				"body")
			.item(0);
        ...
        if (!document.getElementById(J(
			"overlay"))) {
            var ak = document.createElement(
				"div");
            ak.setAttribute("id", J("overlay"));
            ak.style.display = "none";
            aK.appendChild(ak);
            var aI = document.createElement(
				"div");
            aI.setAttribute("id", J("lightbox"));
            aI.style.display = "none";
            aK.appendChild(aI);
            var aG = document.createElement(
				"div");
            aG.setAttribute("id", J(
				"imageDataContainer"));
            ...
            r.setAttribute("id", J(
				"imageContainerMain"));
            N.appendChild(r);
            var ad = document.createElement(
				"div");
            ad.setAttribute("id", J(
				"imageContainer"));
            r.appendChild(ad);
            var aC = document.createElement(
				"img");
            aC.setAttribute("id", J(
				"lightboxImage"));
            ad.appendChild(aC);
            if (!ah.enableRightClick) {
                var at = document.createElement(
					"div");
            ...
            (ah.shadowLocation ? document.getElementById(
				J(ah.shadowLocation)) : ao)
				.appendChild(aS)
        }
        ...
        if (K) {
            ...
            a(ad)
				.append(R);
            var Q = a(document.createElement(
				"A"));
            Q.css({
                color: "#555",
        ...
        var q = this.start = function (c) {
            ...
            if (ah.startZoom) {
                ...
                aX("lightbox")
					.css({
					    left: c.offset()
							.left - ah.borderSize + "px",
					    top: c.offset()
							.top - ah.borderSize + "px",
					    width: c.width() + ah.borderSize *
							2 + "px",
					    height: "auto"
					})
            } else {
                aX("overlay")
					...
					.show()
					.fadeTo(aW * 1000, ah.overlayOpacity);
                aX("lightbox")
					.css({
					    left: 0,
					    width: "100%"
        ...
        function aD(t, be) {
            ...
            if (ah.featBrowser) {
                ...
                var a5 = (a3 + ah.borderSize * 2 +
					ah.breathingSize * 2) / (bc + ah
					.borderSize * 2 + ah.breathingSize *
					2 + p);
                if (a5 > a0) {
                    var bb = bf.winWidth - ah.borderSize *
						2 - ah.breathingSize * 2;
                    var a6 = Math.round(bb / a7)
                } else {
                    var a6 = bf.winHeight - ah.borderSize *
						2 - ah.breathingSize * 2 - p;
            ...
            var a9 = i();
            if (ah.openByHover) {
                c = Math.min(Math.max(a(av)
						.offset()
						.left + a(av)
						.width() / 2 - a4 / 2, a9.x), a9
					.x + bf.winWidth - a4);
                a1 = Math.min(Math.max(a(av)
						.offset()
						.top + a(av)
						.height() / 2 - a2 / 2, a9.y),
					a9.y + bf.winHeight - a2)
            } else {
                a1 = a9.y + (bf.winHeight - a2) /
					2;
                c = a9.x
            }
            a2 = Math.max(a2, parseInt(aX(
					"lightbox")
				.height()));
            if (a2 > bf.winHeight) {
                a1 = Math.max(Math.min(aX(
							"lightbox")
						.offset()
						.top, a9.y), a9.y + bf.winHeight -
					a2)
            }
            ...
            if (t == true) {
                ...
                if (!be) {
                    if (ah.startZoom) {
                        ...
                        if (d) {
                            d.css({
                                width: (1 > bg ? "auto" : (d.width() /
									d.parent()
									.width()) * 100 + "%"),
                                height: (1 > bg ? (d.height() /
										d.parent()
										.height()) * 100 + "%" :
									"auto"),
                                left: 0,
        ...
        function x() {
            ...
            if (e[Y].title) {
                ...
                var c = ah.strings.numDisplayPrefix +
					" " + parseInt(Y + 1) + " " + ah.strings
					.numDisplaySeparator + " " + e.length;
                if (ah.showGroupName && ab) {
                    c += " " + ah.strings.numDisplaySeparator +
						" " + ab
                }
                aX("numberDisplay")
					.text(c);
        ...
        function aA() {
            ...
            U();
            aX("slideShowControl")
				.text(ah.strings.startSlideshow);
            aX("slideShowControl")
				.removeClass("started")
        }
        ...
        function E() {
            var d = e.length - 1 == Y ? 0 : Y +
				1;
            (new Image())
				.src = e[d].link;
            var c = Y == 0 ? e.length - 1 : Y -
				1;
            (new Image())
				.src = e[c].link
        }
        ...
        function A(c) {
            if (c.pageX - aX("imageContainer")
				.offset()
				.left < aX("imageContainer")
				.width() / 2) {
                aX("prevLinkImg")
					.addClass("hover");
                aX("nextLinkImg")
        ...
        function X() {
            ...
            for (var t = 0; t < d.length; t++) {
                a0 = document.getElementsByTagName(
					d[t]);
        ...
        function O() {
            var c = document.body,
				...
				t = 0;
            if (a0) {
                d = Math.max(d, a0.scrollWidth, a0
					.offsetWidth);
                t = Math.max(t, a0.scrollHeight,
					a0.offsetHeight)
            }
            if (c) {
