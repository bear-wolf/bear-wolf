...
@Component({
  selector: 'app-activity-basic-marketing-fines',
  templateUrl: './activity-basic-marketing-fines.component.html',
  styleUrls: ['./activity-basic-marketing-fines.component.scss']
})
export class ActivityBasicMarketingFinesComponent extends CommonInner implements OnInit {
  @Input()
